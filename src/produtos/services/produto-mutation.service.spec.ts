...
import { ProdutoMutationService } from './produto-mutation.service';

describe('ProdutoMutationService', () => {
  let service: ProdutoMutationService;
  ...
  beforeEach(() => {
    ...
    service = new ProdutoMutationService(
